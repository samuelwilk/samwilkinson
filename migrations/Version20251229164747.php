 ...
 */
final class Version20251229164747 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        , is_published BOOLEAN NOT NULL, uploaded_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, sort_order INTEGER DEFAULT NULL, CONSTRAINT FK_14B78418514956FD FOREIGN KEY (collection_id) REFERENCES collection (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
