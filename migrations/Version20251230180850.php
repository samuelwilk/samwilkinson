 ...
 */
final class Version20251230180850 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add fileHash field to Photo entity for duplicate detection';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TEMPORARY TABLE __temp__photo AS SELECT id, collection_id, filename, title, caption, taken_at, width, height, aspect_ratio, exif_data, is_published, uploaded_at, updated_at, sort_order, use_for_index_cover FROM photo');
        ...
        , is_published BOOLEAN NOT NULL, uploaded_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, sort_order INTEGER DEFAULT NULL, use_for_index_cover BOOLEAN DEFAULT 0 NOT NULL, file_hash VARCHAR(64) DEFAULT NULL, CONSTRAINT FK_14B78418514956FD FOREIGN KEY (collection_id) REFERENCES collection (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
